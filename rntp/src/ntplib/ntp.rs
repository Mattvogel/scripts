...
// implement NTPTimestamp as timespec seconds and nanoseconds from epoch
impl NTPTimestamp {
...
// implementation of NTPHeader packet structure within ntplib, decoding and encoding
impl NTPHeader {
...
// mutable buffer definition and distinctions 
...
// Packet structure definiton into readable format. 
